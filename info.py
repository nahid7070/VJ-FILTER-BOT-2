...
API_ID = int(environ.get('API_ID', '26243378'))
API_HASH = environ.get('API_HASH', '33bf1090ef5a0c98dc46b189b6e4c435')
BOT_TOKEN = environ.get('BOT_TOKEN', "6959150324:AAHofr95g5-Gp9BtwJPGWL8GqHBHdjqqdPA")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', ' 6935552935.').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002019740109').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001883303504')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nahidbd01210:nahidbd01210@cluster0.hqlcqqd.mongodb.net/?retryWrites=true&w=majority")
